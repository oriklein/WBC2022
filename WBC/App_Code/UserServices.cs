...
namespace ISCRegDAL
{
    public class WBCUserServices
    {
        Database dbase;
        DbCommand dbcmd;
        public WBCUserServices()
        {
        ...
        public void Attendee_Add_NY2014(int paymentid, string firstname, string lastname, string organization, string title, string emailId, string phone, string phex, string Country, string otherCountry, string state, string otherstate, string attendeType, string address, string otheraddress, string city, string zip, double Price, string AdminOrder, string paymenttype, string Cocktail, string NextWave, string SohnGeneralPartner)
        {
            dbcmd = dbase.GetStoredProcCommand("IRA_Tbl_AttendeeInformations_NEW_2014");
            dbase.AddInParameter(dbcmd, "@paymentid", DbType.Int32, paymentid);
            dbase.AddInParameter(dbcmd, "@FirstName", DbType.String, firstname);
            dbase.AddInParameter(dbcmd, "@LastName", DbType.String, lastname);
            dbase.AddInParameter(dbcmd, "@Organization", DbType.String, organization);
            ...
            dbase.AddInParameter(dbcmd, "@PaymentType", DbType.String, paymenttype);
            dbase.AddInParameter(dbcmd, "@Cocktail", DbType.String, Cocktail);
            dbase.AddInParameter(dbcmd, "@NextWave", DbType.String, NextWave);
            dbase.AddInParameter(dbcmd, "@SohnGeneralPartner", DbType.String, SohnGeneralPartner);
           
            dbase.ExecuteNonQuery(dbcmd);
        }
        public void Billing_Add_NY2014(int paymentid, string Name, string emailId, string phone, string Address, string OName, string OEmail, string OPhone,string Title,string CCEmail,string Country,string State,string City,string zip,string company)
        {
            dbcmd = dbase.GetStoredProcCommand("usp_Billing_Info");
            dbase.AddInParameter(dbcmd, "@paymentid", DbType.Int32, paymentid);
        ...
        {
            dbcmd = dbase.GetStoredProcCommand("usp_InsertTickets");
        ...
        public void ContributorInfo_Insert(ref int OutId, double amt, string cheqnum, string fname, string lname, string company, string title, string email, string ph, string ext, string adr1, string adr2, string country, string state, string city, string otherCountry, string otherState, string Zip, string type, string ConfirmNum, string ContributorType, string IndOrg, string AdminOrder, int TicketCount,string paymenttype,string Aware,string wbc,string Year,string Mad,string Billing)
        {
            ...
            dbase.AddInParameter(dbcmd, "@IN_PaymentType", DbType.String, paymenttype);
            dbase.AddInParameter(dbcmd, "@Aware", DbType.String, Aware);
            dbase.AddInParameter(dbcmd, "@WBC", DbType.String, wbc);
            dbase.AddInParameter(dbcmd, "@year", DbType.String, Year);
            dbase.AddInParameter(dbcmd, "@mad", DbType.String, Mad);
