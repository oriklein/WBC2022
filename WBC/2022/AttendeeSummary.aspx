<%-- starting line below --%>
<%@ page language="C#" autoeventwireup="true" inherits="AttendeeSummary" CodeFile="AttendeeSummary.aspx.cs"  %>
...
<form id="form1" name="forattendee" runat="server">
        ...
        <div id="dvAttendees" class="row row-indent"  runat="server"> </div>
         <div class="row row-button">
            ...
            <asp:Button ID="btnPay" CssClass="bullet bullet-forward small right" runat="server" Text="Payment"
