<%@ Page Language="C#" AutoEventWireup="true" Inherits="MWF_ContributorIndex" CodeFile="ContributorIndex_NMb.aspx.cs" %>
    ...
    <div class="section">
        <div class="col">
            <div class="article">
                ...
                <ul>
                    <li><%=Convert.ToDouble(WBCPrice.MIndivisual).ToString("C") %> per ticket </li>
                </ul>
    ...
    <div class="section">
        <div class="col">
            <div class="article">
                ...
                Individual Members
                <h3>Non-Member Table :<%=Convert.ToDouble(WBCPrice.NMFullTable).ToString("C") %>   
                </h3>
                <ul>
                ...
                <h3>Additional Non-Member Half Table : <%=Convert.ToDouble(WBCPrice.NMHalfTable).ToString("C") %> 
                </h3>
                <ul>
                ...
                <ul>
                    <li><%=Convert.ToDouble(WBCPrice.NMIndivisual).ToString("C") %>  per ticket </li>
                </ul>
                <h2>Ad in MAD Event Journal</h2>
                <h3>Full Page Ad: <%=Convert.ToDouble(WBCPrice.MFullAD).ToString("C") %> </h3>
                <h3>Half Page Ad: <%=Convert.ToDouble(WBCPrice.MHalfAd).ToString("C") %> </h3>
