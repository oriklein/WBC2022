        ...
        <div id="main">
            <div class="section">
                <div class="col col-100 center">
                    ...
                    <p class="large">Thank you for your table commitment for the 2019 Merit Award Dinner!  Your purchase details are as follows:</p>
                    <h3><%=LvlMsg%></h3>
                    ...
                    <p class="large">Thanks and we look forward to seeing you in May!</p>
                    <p class="large">Jocelyn</p>
                    <p class="large">646-336-6800 EXT 110</p>
