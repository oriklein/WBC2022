    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["ContriCheque"] != null && Session["cost"] != null)
        {
            ...
            if (mb.MemberType == "Yes")
            {
                ...
                Desc += " <p class=\"large\" style=\"text-decoration: underline;font-weight: bold;\">All logos and ads must be submitted by Friday, April 13.</p>";
            ...
            if (mb.MemberType == "No" && (mb.AddFullTable > 0 || mb.AddHalfTable > 0) && mb.AddFullAd == 0 && mb.AddHalfAd == 0)
            {
                ...
                Desc += " <p class=\"large\" style=\"text-decoration: underline;font-weight: bold;\">All logos must be submitted by Friday, April 13.</p>";
            ...
            objMailMesg.Subject = " 2019 Merit Award Dinner Confirmation";
            ...
            html = html + "<div style=\"margin: 0 12.5% !important;width: 75% !important; width: 100%; -moz-box-sizing: border-box;    float: left;    overflow: hidden;    padding: 0 10px 10px;    position: relative;    text-align: left;\">";
            html = html + "<div style=\"padding: 20px 0; overflow: visible;    text-align: center; width: 100%;\">";
            html = html + "<img src=\"http://reg.sequence-events.com/wbc/2019/asset/img-header-logo.png\"></img>";
            html = html + "</div>";
            html = html + "<p style=\"font-size: 12px;    line-height: 1.5em;    margin: 10px 0 0;\">";
            html = html + "Hello!";
            html = html + "</p>";
            html = html + "<p style=\"font-size: 12px;    line-height: 1.5em;    margin: 10px 0 0;\">";
            html = html + "Thank you for your table commitment for the 2019 Merit Award Dinner!  Your purchase details are as follows:";
            html = html + "</p>";
            ...
            html = html + "</h2>";
            html = html + "<p style=\"font-size: 12px;    line-height: 1.5em;    margin: 10px 0 0;\">";
            html = html + "April 18th, 2019<br />6:00pm Cocktails | 7:00pm - 10:00pm Dinner<br /><br />Business Attire<br />American Museum of Natural History<br /> Central Park West at 79th St.<br />New York, NY, 10024";
            html = html + "</p>";
            if (mb.MemberType == "Yes")
            {
                html = html + "<p style=\"font-size: 12px;    line-height: 1.5em;    margin: 10px 0 0;\">";
                ...
                html = html + "All logos and ads must be submitted by Friday, April 13.";
                html = html + "</p>";
            ...
            if (mb.MemberType == "No" && (mb.AddFullTable > 0 || mb.AddHalfTable > 0) && mb.AddFullAd == 0 && mb.AddHalfAd == 0)
            {
                ...
                html = html + "</p>";
                html = html + "<p style=\"font-size: 12px; font-weight: bold;   line-height: 1.5em; text-decoration:underline;   margin: 10px 0 0;\">";
                html = html + "All logos must be submitted by Friday, April 13.";
                html = html + "</p>";
                html = html + "<p style=\"font-size: 12px; font-weight: bold;   line-height: 1.5em;    margin: 10px 0 0;\">";
