	...
	var imagePath='media/timepicker/';
			...
			for (i=0;i<=11;i++)
			{
				...
				for (j=0;j<2;j++)
				{
					if( suffix =="AM")
					{
						...
						{*/
							sHTML+="<td width=114 style='cursor:hand' onmouseover='this.style.backgroundColor=\"#D4E4F0\"' onmouseout='this.style.backgroundColor=\"\"' onclick='setTimePicker(\""+ hr + ":" + padZero_T(j*30) + " " + suffix + "\")'><a style='text-decoration:none;color:#000000' href='javascript:setTimePicker(\""+ hr + ":" + padZero_T(j*30) + " " + suffix + "\")'>" + hr + ":"+padZero_T(j*30) + "<font color=\"#808080\">" + suffix + "</font></a></td>";
						//}
						}
					}
					else if(suffix == "PM")
