...
<script Language="C#" runat="server">
    ...
    {
        SendMails();
        Response.Redirect("http://reg.sequence-events.com/wbc/2018/oops.aspx");
    }
    protected void Application_BeginRequest(object sender, EventArgs e)
    {
        ...
        //// }
        if (Request.Url.ToString().ToLower().Contains("/wbc/2016/"))
        {

            Response.Redirect(Request.Url.ToString().ToLower().Replace("wbc/2016/","wbc2015/2015/"));
        }
         if (Request.Url.ToString().ToLower().Contains("/wbc/2017/"))
        {

            Response.Redirect(Request.Url.ToString().ToLower().Replace("wbc/2017/","wbc/2018/"));
        }
        if (!Request.Url.ToString().ToLower().Contains("/wbc/2022")&&!Request.Url.ToString().ToLower().Contains("/wbc2015"))
        {

            Response.Redirect("http://reg.sequence-events.com/wbc/2022/index.aspx");
        }
    ...
    private void SendMails()
    {
        ...
        ObjMailMessage.From = new MailAddress(System.Configuration.ConfigurationManager.AppSettings["CFNSAdminMailID"], "Women's Bond Club Error");
        ObjMailMessage.Subject = "FA Generic - Error page ";
        ObjMailMessage.To.Add("sree@locustsystems.com");//System.Configuration.ConfigurationSettings.AppSettings["FAErrorMailID"];
